(function (global) {
    ...
    function updateDoorItem(item, doorId, { selectedDoor, isDone, condition, colors, label, colorOverride, statusLabel }) {
        ...
        if (dot)
            dot.style.background = colorOverride || doorColor({ isDone, condition, colors });
        ...
        if (status) {
            ...
            else if (isDone && condition === 'attention') {
    ...
    function renderDoorList({ listEl, headerEl, doorIds, selectedDoor, getDoorStatus, getDoorCondition, getDoorLabel, getDoorPresentation, colors, onSelect, }) {
        ...
        sortedDoorEntries.forEach(({ doorId, label }) => {
            ...
            const presentation = getDoorPresentation?.(doorId) || null;
            updateDoorItem(item, doorId, {
                ...
                colors,
                label,
                colorOverride: presentation?.color,
    ...
    function createController({ elements, getDoorIds, getSelectedDoor, getDoorStatus, getDoorCondition, getDoorLabel, getDoorPresentation, colors, onSelect, setShellOpen, }) {
