...
function renderAdminSessionsPopup() {
    if (typeof renderAdminUsageHistory === 'function') {
...
function showAdminSessionsPopup() {
    ...
    if (typeof loadAdminUsageHistory === 'function') {
        loadAdminUsageHistory({ reset: true });
        return;
    }
...
function hideAdminSessionsPopup() {
    if (typeof cancelAdminUsageHistory === 'function')
        cancelAdminUsageHistory();
