(function (global) {
    ...
    const fileNameCollator = new Intl.Collator('nl', { numeric: true, sensitivity: 'base' });
    function createBatchImporter({ elements, controls, getPdfJsLib, nextGeneration, isGenerationCurrent, showToast, onStateChanged = () => { }, onEmpty = () => { }, }) {
        ...
        async function importFiles(fileList) {
            ...
            const files = Array.from(fileList || [])
                ...
                .sort((left, right) => fileNameCollator.compare(left.file.name, right.file.name) || left.index - right.index)
