(function (global) {
    ...
    function create(deps) {
        const { Flow, state, options, helpers, element, readFile, renderInputField, renderNulBeurt, renderSummary, rerender } = deps;
        ...
        function renderPhoto(kind) {
            ...
            if (entry) {
                ...
                remove.addEventListener('click', () => { state.photos[kind] = []; persist(); rerender(''); });
