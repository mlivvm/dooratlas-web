(function (global) {
    ...
    function attachBatchHandlers(pdfHandlers, ctx) {
        const { elements, controls, modeController, modes, ensureSession, onSave, onSaved, showToast, hidePopup, currentCustomers, materializeContext = async (context) => context, validationCustomers = currentCustomers, } = ctx;
