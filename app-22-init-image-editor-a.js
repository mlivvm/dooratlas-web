...
FD.MobileDeviceSessionService.create({
    config: CONFIG,
    hideMenu: hideTopbarMenu,
    showToast,
    elements: {
        openButton: document.getElementById('btn-mobile-devices'),
        overlay: document.getElementById('mobile-devices-overlay'),
        popup: document.getElementById('mobile-devices-popup'),
        closeButton: document.getElementById('mobile-devices-close'),
        summary: document.getElementById('mobile-devices-summary'),
        list: document.getElementById('mobile-devices-list'),
    },
});
...
async function init() {
    ...
    FD.HomeMenuService?.refreshCurrentStartState?.();
